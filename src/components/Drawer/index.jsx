...
function Drawer({ Component }) {
    ...
    return (
        <div className="drawer drawer-mobile">
            <input id="my-drawer-99" type="checkbox" className="drawer-toggle" />
            <div className="drawer-content flex flex-col justify-center maxWidth">
                <div className="mt-20">
                    <label htmlFor="my-drawer-99" className="absolute z-10 btn btn-circle swap swap-rotate drawer-button lg:hidden mt-9 ml-5">
                        <input type="checkbox" />
            ...
            <div className="drawer-side">
                <label htmlFor="my-drawer-99" className="drawer-overlay"></label>
