function About({ language }) {
    ...
    const parrEs = ["Soy un joven desarrollador full-stack con casi 2 años de experiencia en el desarrollo de aplicaciones web y móviles. Actualmente soy estudiante universitario de Ingeniería de Sistemas, lo que me ha dado una sólida formación teórica y técnica en programación.",
